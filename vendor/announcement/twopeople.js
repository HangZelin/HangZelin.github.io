// Restored from the original blog announcement widget.
window.initAnnouncementFigure = function(canvas) {
	          // Made with Zdog
	...
	function animate() {
      if (!illoElem.isConnected) return;
	  update();
	  illo.renderGraph();
